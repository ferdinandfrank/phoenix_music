...
//        ];
        ...
        $tracks = [
            [
                ...
                'composer_id'  => 1,
                'file'         => '/storage/audio/intense_whoosh_sounds.mp3',
            ...
            [
                ...
                'composer_id'  => 1,
                'file'         => '/storage/audio/survival_menu_theme.mp3',
            ...
            [
                ...
                'composer_id'  => 1,
                'file'         => '/storage/audio/intense_banner_intro.mp3',
...
These sounds are perfect for intros, trailers, websites and more. ',
                'composer_id'  => 1,
                'file'         => '/storage/audio/intense_whoosh_sounds2.mp3',
            ...
            [
                ...
                'composer_id'  => 1,
                'file'         => '/storage/audio/horror_menu_music.mp3',
                'length'       => '1:53',
                'bpm'          => '135',
            ...
            [
                ...
                'composer_id'  => 1,
                'file'         => '/storage/audio/intense_epic_hybrid_orchestra_trailer.mp3',
                'length'       => '2:50',
                'bpm'          => '95',
            ...
            [
                ...
                'composer_id'  => 1,
                'file'         => '/storage/audio/a_new_day.mp3',
                'length'       => '2:07, 2:07',
                'bpm'          => '80',
            ...
            [
                ...
                'composer_id'  => 1,
                'file'         => '/storage/audio/rock_on_ident.mp3',
                'length'       => '0:17',
                'bpm'          => '140',
...
',
                'composer_id'  => 1,
                'file'         => '/storage/audio/sunrise_earth.mp3',
                'length'       => '1:45, 1:45',
                'bpm'          => '120',
            ...
            [
                ...
                'composer_id'  => 1,
                'file'         => '/storage/audio/quantum_energy.mp3',
            ...
            [
                ...
                'composer_id'  => 1,
                'file'         => '/storage/audio/rising_skylands.mp3',
            ...
            [
                ...
                'composer_id'  => 1,
                'file'         => '/storage/audio/epic_hybrid_riser_ident.mp3',
            ...
            [
                ...
                'composer_id'  => 1,
                'file'         => '/storage/audio/fire_and_passion.mp3',
                'length'       => '1:19',
                'bpm'          => '140',
            ...
            [
                ...
                'description'  => 'An epic track, realeased on the first public album of Phoenix Music, called <i>The First Spirit</i>.',
                'composer_id'  => 1,
                'file'         => '/storage/audio/forbidden_love.mp3',
                'length'       => '4:15',
                'bpm'          => '120',
                'published_at' => '2014-11-13',
            ...
            [
                ...
                'description'  => 'An epic track, realeased on the first public album of Phoenix Music, called <i>The First Spirit</i>.',
                'composer_id'  => 1,
                'file'         => '/storage/audio/force_of_time.mp3',
                'length'       => '2:22',
                'bpm'          => '100',
                'published_at' => '2014-11-13',
            ...
            [
                ...
                'description'  => 'An epic track, realeased on the first public album of Phoenix Music, called <i>The First Spirit</i>.',
                'composer_id'  => 1,
                'file'         => '/storage/audio/glory_and_honor.mp3',
                'length'       => '4:09',
                'bpm'          => '140',
                'published_at' => '2014-11-13',
            ...
            [
                ...
                'description'  => 'An epic track, realeased on the first public album of Phoenix Music, called <i>The First Spirit</i>.',
                'composer_id'  => 1,
                'file'         => '/storage/audio/guardians_of_the_earth.mp3',
                'length'       => '4:25',
                'bpm'          => '125',
                'published_at' => '2014-11-13',
            ...
            [
                ...
                'description'  => 'An epic track, realeased on the first public album of Phoenix Music, called <i>The First Spirit</i>.',
                'composer_id'  => 1,
                'file'         => '/storage/audio/planet_earth.mp3',
                'length'       => '4:11',
                'bpm'          => '140',
                'published_at' => '2014-11-13',
                'tags'         => 'epic, piano, uplifting, choir, strings, trailer music',
            ...
            [
                ...
                'description'  => 'An epic track, realeased on the first public album of Phoenix Music, called <i>The First Spirit</i>.',
                'composer_id'  => 1,
                'file'         => '/storage/audio/reflections.mp3',
                'length'       => '2:08',
                'bpm'          => '100',
                'published_at' => '2014-11-13',
...
',
            ...
            [
                ...
                'description'  => 'An epic track, realeased on the first public album of Phoenix Music, called <i>The First Spirit</i>.',
                'composer_id'  => 1,
                'file'         => '/storage/audio/starbreaker.mp3',
                'length'       => '3:22',
                'bpm'          => '100',
                'published_at' => '2014-11-13',
...
This track was also realeased on the first public album of Phoenix Music, called <i>The First Spirit</i>.',
                'composer_id'  => 1,
                'file'         => '/storage/audio/sword_of_faith.mp3',
                'length'       => '3:45',
                'bpm'          => '85',
                'published_at' => '2014-11-13',
...
This track is also part of the first public album of Phoenix Music, called <i>The First Spirit</i>.',
                'composer_id'  => 1,
                'file'         => '/storage/audio/vindictus.mp3',
                'length'       => '4:30',
                'bpm'          => '80',
                'published_at' => '2014-11-13',
            ...
            [
                ...
                'description'  => 'An epic track, realeased on the first public album of Phoenix Music, called <i>The First Spirit</i>.',
                'composer_id'  => 1,
                'file'         => '/storage/audio/world_of_tomorrow.mp3',
                'length'       => '2:30',
                'bpm'          => '95',
                'published_at' => '2014-11-13',
