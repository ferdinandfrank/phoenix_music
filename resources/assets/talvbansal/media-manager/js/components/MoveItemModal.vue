            ...
            <div v-else>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Move to</label>
                        <select class="form-control" v-model="newFolderLocation" id="newFolderLocation"
                                name="newFolderLocation" @keyup.enter="moveItem()">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-success" @click="moveItem()">
                        Apply
                    </button>
                </div>
            </div>
