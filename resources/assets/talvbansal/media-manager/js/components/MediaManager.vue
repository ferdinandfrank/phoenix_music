            ...
            <div class="modal-header">
                ...
                <div class="btn-toolbar" role="toolbar">
                    <div class="btn-group flex-start">
                        ...
                        <button class="btn btn-primary btn-icon-text" type="button" title="Add Folder"
                                @click="showCreateFolderModal = true">
                            <i class="icon-folder-plus"></i>
                            <span class="xs-hidden">Add folder</span>
                        </button>

                        <button class="btn btn-default btn-icon-text" type="button" @click="loadFolder(currentPath)"
                                title="Refresh">
                            <i class="icon-loop2"></i>
                            <span class="xs-hidden">Refresh</span>
                        </button>

                        <button class="btn btn-default btn-icon-text" type="button" :disabled="!currentFile"
                                @click="showMoveItemModal = true" title="Move">
                            <i class="icon-arrow-right"></i>
                            <span class="xs-hidden">Move</span>
                        </button>

                        <button class="btn btn-default btn-icon-text" type="button" :disabled="!currentFile"
                                @click="showDeleteItemModal = true" title="Delete">
                            <i class="icon-bin"></i>
                            <span class="xs-hidden">Delete</span>
                        </button>

                        <button class="btn btn-default btn-icon-text" type="button" :disabled="!currentFile"
                                title="Rename" @click="showRenameItemModal = true">
                            <i class="icon-pencil"></i>
                            <span class="xs-hidden">Rename</span>
                        </button>
                    </div>
            ...
            <div>
                ...
                <div v-else>
                    <div class="easel-file-browser">
                        ...
                        <div class="row">
                            <div :class="{ 'sm-12' : !currentFile || isFolder(currentFile), 'sm-9' : currentFile && ! isFolder(currentFile) }"
                                 class="col xs-12">
                                ...
                                <div class="table-responsive easel-file-picker-list">
                                    <table class="table table-condensed table-vmiddle">
                                        ...
                                        <tr v-for="(folder, path) in folders"
                                            :class="[ (folder == currentFile) ? 'active' : '' ]">
                                            <td>
                            ...
                            <div v-if="currentFile && !isFolder(currentFile)"
                                 class="easel-file-picker-sidebar xs-hidden col sm-3">
                                ...
                                <table class="table table-condensed table-vmiddle easel-file-picker-preview-table">
                                    <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="file-value">
                                            <a :href="currentFile.webPath" target="_blank" rel="noopener">{{
                ...
                <div class="modal-footer vertical-center">
                    ...
                    <div v-if="isModal" class="btn-group">
                        <button type="button" class="btn btn-primary" v-show="currentFile && !isFolder(currentFile)"
                                @click="selectFile()">
                            Select File
                        </button>
                ...
                this.$http.get('/admin/browser/index?path=' + path).then(
                    ...
                    function (response) {
                        if (response.data.error) {
                            this.mediaManagerNotify(response.data.error, 'error');
                        }
